...
do
    ...
    # training set of 50k
    uv run python -m arithmetic.generate --num_examples 50000 --min_value 10_000 --max_value 100_000 --num_values $i --do_generate $do_generate --do_promptify $do_promptify --do_fewshot $do_fewshot
    # training set of 20k
